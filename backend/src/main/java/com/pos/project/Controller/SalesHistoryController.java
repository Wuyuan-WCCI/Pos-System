...
public class SalesHistoryController {
        ...
        private static final Logger logger = Logger.getLogger(SalesHistoryController.class.getName());
        ...
        public Page<Order> getSalesByDay(
                ...
                logger.info(String.format("Fetching sales by day for date: %s, pageSize: %d, page: %d", date, pageSize,
                                page));
                logger.info(String.format("Date range: %s to %s", startOfDay, endOfDay));
        ...
        public Page<Order> getSalesByWeek(
                ...
                logger.info(String.format("Fetching sales by week for date: %s, pageSize: %d, page: %d", date, pageSize,
                                page));
        ...
        public Page<Order> getSalesByMonth(
                ...
                logger.info(String.format("Fetching sales by month for date: %s, pageSize: %d, page: %d", date,
                                pageSize, page));
        ...
        public Page<Order> getSalesByYear(
                ...
                logger.info(String.format("Fetching sales by year for date: %s, pageSize: %d, page: %d", date, pageSize,
                                page));
